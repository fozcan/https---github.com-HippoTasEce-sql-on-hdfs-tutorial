...
{\em SequenceFiles} are flat files of key/value pairs. While these formats are widely used for many Hadoop
tasks, column-oriented, more accurately PAX-like \cite{AilamakiDHS01}, file formats are more popularly used with SQL-on-Hadoop systems. These formats include {\em RC}, {\em ORC} and {\em DWRF} \cite{dwrf}, as well as {\em Parquet}. In this tutorial,
we will present these file formats and compare them in terms of usability, data size (compression) and speed of processing.
